    ...
    <div className="space-y-8">
      ...
      <div className="grid grid-cols-3 gap-4">
        <div className="bg-white dark:bg-zinc-900 border border-zinc-200 dark:border-zinc-800 rounded-xl p-4">
          <p className="text-sm text-zinc-500">총 대화</p>
          <p className="text-2xl font-bold text-zinc-900 dark:text-zinc-100">
            {convs.length}
          </p>
        </div>
        <div className="bg-white dark:bg-zinc-900 border border-zinc-200 dark:border-zinc-800 rounded-xl p-4">
          <p className="text-sm text-zinc-500">수집된 리드</p>
          <p className="text-2xl font-bold text-amber-500">
            {allLeads.length}
          </p>
        </div>
        <div className="bg-white dark:bg-zinc-900 border border-zinc-200 dark:border-zinc-800 rounded-xl p-4">
          <p className="text-sm text-zinc-500">오늘 대화</p>
          <p className="text-2xl font-bold text-zinc-900 dark:text-zinc-100">
            {
              convs.filter(
                (c) =>
      ...
      <section>
        ...
        {allLeads.length === 0 ? (
          <p className="text-zinc-500 text-sm">아직 수집된 리드가 없습니다</p>
        ) : (
      ...
      <section>
        ...
        {convs.length === 0 ? (
          <p className="text-zinc-500 text-sm">아직 대화 기록이 없습니다</p>
        ) : (
